...
gradlePlugin {
  plugins {
    create("licenseScribeHilt") {
      ...
      displayName = "License Scribe Hilt Plugin"
      description = "A Gradle plugin that generates Hilt module for License Scribe LicenseProvider integration"
    }
  }
}
...
publishing {
  publications {
    ...
    withType<MavenPublication>().configureEach {
      ...
      pom {
        name.set("License Scribe Hilt Plugin")
        description.set("A Gradle plugin that generates Hilt module for License Scribe LicenseProvider integration")
